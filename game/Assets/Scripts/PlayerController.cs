...
public class PlayerController : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        // Shift player + levitation
        if (Input.GetKeyDown(KeyCode.LeftShift) || Input.GetButtonDown("ShiftPlayer"))
        {
            shiftPlayer = 1;
        ...
        if (Input.GetKeyUp(KeyCode.LeftShift) || Input.GetButtonUp("ShiftPlayer"))
        {
            shiftPlayer = 0;
        ...
        if (shiftPlayer == 0)
        {
            ...
            // Run LeftControl 
            if (Input.GetKeyDown(KeyCode.LeftControl) || Input.GetButtonDown("Run"))
            {
                speed = 8;
            }
            if (Input.GetKeyUp(KeyCode.LeftControl) || Input.GetButtonUp("Run"))
            {
                speed = 5;
            }
        }
